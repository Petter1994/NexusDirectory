...
import DirectoryCard from '@/components/Directory/Card/DirectoryCard'
            ...
            <section id="directory" className="py-16 md:py-20 lg:py-28" >
                <div className="container">
                    <SectionTitle
                        ...
                        paragraph="Más que un directorio, tu mapa hacia el talento turístico."
                        center
                    />

                    <div className='flex justify-start gap-5'>
                        <Tooltip content={showFilter ? 'Esconder Filtros' : 'Mostrar Filtros'}>
                            <Button
                                isIconOnly
                                aria-label="Filtros"
                                color="primary"
                    ...
                    <div
                        className="grid grid-cols-1 gap-x-8 gap-y-10 md:grid-cols-2 md:gap-x-6 lg:gap-x-8 xl:grid-cols-3 mt-10">
